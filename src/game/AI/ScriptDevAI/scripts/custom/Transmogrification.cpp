...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
	switch (slot)
	{
	case EQUIPMENT_SLOT_HEAD: return  "Kopf";// session->GetAcoreString(LANG_SLOT_NAME_HEAD);
	case EQUIPMENT_SLOT_SHOULDERS: return  "Schultern";// session->GetAcoreString(LANG_SLOT_NAME_SHOULDERS);
	case EQUIPMENT_SLOT_BODY: return  "Hemd";// session->GetAcoreString(LANG_SLOT_NAME_BODY);
	case EQUIPMENT_SLOT_CHEST: return  "Brust";// session->GetAcoreString(LANG_SLOT_NAME_CHEST);
	case EQUIPMENT_SLOT_WAIST: return  "Taille";// session->GetAcoreString(LANG_SLOT_NAME_WAIST);
	case EQUIPMENT_SLOT_LEGS: return  "Beine";// session->GetAcoreString(LANG_SLOT_NAME_LEGS);
	case EQUIPMENT_SLOT_FEET: return  "Füße";// session->GetAcoreString(LANG_SLOT_NAME_FEET);
	case EQUIPMENT_SLOT_WRISTS: return  "Handgelenke";// session->GetAcoreString(LANG_SLOT_NAME_WRISTS);
	case EQUIPMENT_SLOT_HANDS: return  "Hands";// session->GetAcoreString(LANG_SLOT_NAME_HANDS);
	case EQUIPMENT_SLOT_BACK: return  "Zurück";// session->GetAcoreString(LANG_SLOT_NAME_BACK);
	case EQUIPMENT_SLOT_MAINHAND: return  "Waffenhand";// session->GetAcoreString(LANG_SLOT_NAME_MAINHAND);
	case EQUIPMENT_SLOT_OFFHAND: return  "Schildhand";// session->GetAcoreString(LANG_SLOT_NAME_OFFHAND);
	case EQUIPMENT_SLOT_RANGED: return  "Distanz";// session->GetAcoreString(LANG_SLOT_NAME_RANGED);
	case EQUIPMENT_SLOT_TABARD: return  "Wappenrock";// session->GetAcoreString(LANG_SLOT_NAME_TABARD);
